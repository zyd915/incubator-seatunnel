...
import org.apache.flink.connector.clickhouse.split.BaseClickHouseParametersProvider;
...
public abstract class AbstractClickHouseInputFormat extends RichInputFormat<RowData, InputSplit>
    ...
    protected String getQuery(String table, String database) {
        ...
        return whereBuilder.length() > 0 ? String.join(" ", queryTemplate, "WHERE", whereBuilder.toString(), limitClause)
    ...
    public static class Builder {
        ...
        public AbstractClickHouseInputFormat build() {
            ...
            return readOptions.isUseLocal() ? createShardInputFormat(logicalTypes)
        ...
        private void initPartitionInfo(int[] shardIds) {
            try {
                BaseClickHouseParametersProvider parametersProvider =
                        new BaseClickHouseParametersProvider.Builder()
