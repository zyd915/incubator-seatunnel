...
public class ClickHouseConverterUtils {
    ...
    public static final long TIME_1000_SECOND = 1_000_000L;
    ...
    public static Object toExternal(Object value, LogicalType type) {
        switch (type.getTypeRoot()) {
            ...
            case TIME_WITHOUT_TIME_ZONE:
                LocalTime localTime = LocalTime.ofNanoOfDay(((Integer) value) * TIME_1000_SECOND);
    ...
    public static Object toInternal(Object value, LogicalType type) throws SQLException {
        switch (type.getTypeRoot()) {
            ...
            case TIME_WITHOUT_TIME_ZONE:
                return (int) (((Time) value).toLocalTime().toNanoOfDay() / TIME_1000_SECOND);
            case TIMESTAMP_WITH_TIME_ZONE:
            case TIMESTAMP_WITHOUT_TIME_ZONE:
