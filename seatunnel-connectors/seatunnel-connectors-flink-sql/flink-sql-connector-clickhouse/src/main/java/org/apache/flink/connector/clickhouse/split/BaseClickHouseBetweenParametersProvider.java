...
public abstract class BaseClickHouseBetweenParametersProvider extends BaseClickHouseParametersProvider {
    ...
    public BaseClickHouseBetweenParametersProvider(long minVal, long maxVal) {
