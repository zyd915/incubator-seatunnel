...
public abstract class BaseClickHouseParametersProvider {
    ...
    public abstract BaseClickHouseParametersProvider ofBatchNum(Integer batchNum);

    public abstract BaseClickHouseParametersProvider calculate();
    ...
    public static class Builder {
        ...
        public BaseClickHouseParametersProvider build() {
            BaseClickHouseParametersProvider parametersProvider = null;
            ...
            if (parametersProvider == null) {
                parametersProvider =
                        useLocal && shardIds != null ? new ClickHouseShardBetweenParametersProvider(minVal, maxVal, shardIds)
