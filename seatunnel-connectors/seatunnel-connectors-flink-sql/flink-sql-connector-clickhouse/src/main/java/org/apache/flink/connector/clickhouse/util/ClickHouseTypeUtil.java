...
public class ClickHouseTypeUtil {
    ...
    public static final int PRECISION_18 = 18;
    ...
    public static DataType toFlinkType(ClickHouseColumnInfo clickHouseColumnInfo) {
        switch (clickHouseColumnInfo.getClickHouseDataType()) {
            ...
            case Decimal32:
                return DataTypes.DECIMAL(PRECISION_9, clickHouseColumnInfo.getScale());
            case Decimal64:
                return DataTypes.DECIMAL(PRECISION_18, clickHouseColumnInfo.getScale());
            case Decimal128:
            case Decimal256:
                return DataTypes.DECIMAL(
